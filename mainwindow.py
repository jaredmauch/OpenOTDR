...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.metaTableView.sizePolicy().hasHeightForWidth())
        self.metaTableView.setSizePolicy(sizePolicy)
        self.metaTableView.setMinimumSize(QtCore.QSize(300, 200))
        self.metaTableView.setSortingEnabled(True)
